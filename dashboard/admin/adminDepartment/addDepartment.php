<?php
    ...
    // Check Request To Add New Department
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        elseif(filter_var($title, FILTER_VALIDATE_EMAIL) || filter_var($title, FILTER_VALIDATE_INT) || filter_var($title, FILTER_VALIDATE_URL)){
            ...
            $sql = "SELECT id FROM department WHERE name = '$title'";
            $count = mysqli_num_rows(mysqli_query($con,$sql));
            
            if($count == 1){
                $errorFlag = 1;
                $errorMessage = 'Department Found Before';
            }
            else{
                //Insert Data 
                $sql = "INSERT INTO department (name) VALUES ('$title')";
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="displayDepartment.php">Admin Department</a></li>
                        ...
                        <div class="card-body">
                            <form  action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                                <div class="form-group">
                                    <label class="small mb-1" for="inputTitleDepartment"><h4>Title Department</h4></label>
                                    <input class="form-control py-4"  name="title" id="inputTitleDepartment" type="text" placeholder="Enter New Role title"  required />
                                    <?php
                                        if($errorFlag == 1){
